# -*- coding: utf-8 -*-
#
# bhp_base_form documentation build configuration file, created by
...
htmlhelp_basename = 'bhp_base_formdoc'
...
latex_documents = [
  ('index', 'bhp_base_form.tex', u'bhp\\_base_form Documentation',
...
man_pages = [
    ('index', 'bhp_base_form', u'bhp_base_form Documentation',
...
texinfo_documents = [
  ('index', 'bhp_base_form', u'bhp_base_form Documentation',
   u'erik van widenfelt', 'bhp_base_form', 'One line description of project.',
   'Miscellaneous'),
]
